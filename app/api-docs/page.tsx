        ...
        {[
          {
            ...
            sub: "forever",
            color: "#8892b0",
            limits: ["10 req/min", "100 req/day"],
            endpoints: ["All endpoints (limited results)", "/api/v1/flow (full)", "/api/v1/health"],
            cta: "Start building",
            ctaLink: "mailto:hello@quivermarkets.com?subject=API Key Request — Free",
          },
          {
            tier: "Pro",
            price: "$150",
            ...
            endpoints: ["All Free endpoints (expanded)", "/api/v1/disagreements/history (7d)", "/api/v1/whales/{address}/positions"],
            cta: "Get Pro access",
            ctaLink: "mailto:hello@quivermarkets.com?subject=API Key Request — Pro",
            featured: true,
          },
          {
            tier: "Premium",
            ...
            endpoints: ["All Pro endpoints (expanded)", "/api/v1/disagreements/history (90d)", "Full market universe (6,070+)", "Priority support & SLA"],
            cta: "Contact us",
            ctaLink: "mailto:hello@quivermarkets.com?subject=API Key Request — Premium",
          },
        ].map((t) => (
          <Card
            key={t.tier}
