...
import { Check, X, Star, ChevronDown, ChevronUp, Zap, Code, Building2 } from "lucide-react";
...
const COMPARISON: FeatureSection[] = [
  {
    ...
    rows: [
      { label: "Cross-platform arbitrage scanner", free: true, pro: true, quant: true, premium: true },
      { label: "AI Market Thesis (preview)", free: true, pro: true, quant: true, premium: true },
      { label: "AI Market Thesis (full)", free: false, pro: true, quant: true, premium: true },
      { label: "Smart Signal Alerts (top 5)", free: true, pro: true, quant: true, premium: true },
      { label: "Smart Signal Alerts (all 50+)", free: false, pro: true, quant: true, premium: true },
      { label: "Whale leaderboard", free: true, pro: true, quant: true, premium: true },
      { label: "Whale position history", free: false, pro: true, quant: true, premium: true },
      { label: "Copy-the-Whales", free: true, pro: true, quant: true, premium: true },
      { label: "Smart Money Flow", free: true, pro: true, quant: true, premium: true },
    ],
  },
  {
    heading: "DATA",
    rows: [
      { label: "6,070+ markets", free: true, pro: true, quant: true, premium: true },
      { label: "286 disagreements", free: true, pro: true, quant: true, premium: true },
      { label: "149 whale wallets", free: true, pro: true, quant: true, premium: true },
      { label: "News catalysts", free: true, pro: true, quant: true, premium: true },
      { label: "Spread history", free: false, pro: "7d", quant: "30d", premium: "90d" },
      { label: "Historical archive", free: false, pro: false, quant: false, premium: "Full" },
    ],
  },
  {
    heading: "API",
    rows: [
      { label: "REST endpoints", free: false, pro: false, quant: true, premium: true },
      { label: "Rate limit / minute", free: false, pro: false, quant: "60", premium: "600" },
      { label: "Rate limit / day", free: false, pro: false, quant: "5,000", premium: "100,000" },
      { label: "Webhooks", free: false, pro: false, quant: "Soon", premium: "Soon" },
      { label: "CSV export", free: false, pro: false, quant: true, premium: true },
    ],
  },
  {
    heading: "SUPPORT",
    rows: [
      { label: "Email support", free: true, pro: true, quant: true, premium: true },
      { label: "Priority support", free: false, pro: true, quant: true, premium: true },
      { label: "Slack channel", free: false, pro: false, quant: false, premium: true },
      { label: "Custom data requests", free: false, pro: false, quant: false, premium: true },
      { label: "Weekly Smart Money Report", free: false, pro: false, quant: false, premium: true },
    ],
  },
];
        ...
        {tiers.map((tier) => (
          <div
            ...
            className={`rounded-2xl bg-[#222638] border flex flex-col transition-all ${
              tier.featured
                ? "border-[#57D7BA] ring-1 ring-[#57D7BA]/20 scale-[1.02] shadow-lg shadow-[#57D7BA]/10 xl:-mt-2 xl:-mb-2"
                : "border-[#2f374f]"
            }`}
          >
            <div className="p-5 flex flex-col gap-4 flex-1">
              {/* Badge */}
              <div
                className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full self-start text-[10px] font-bold uppercase tracking-wide"
              ...
              {/* Description */}
              <p className="text-[12px] text-[#8892b0] leading-relaxed">{tier.description}</p>
                ...
                {tier.features.map((f) => (
                  <li key={f.label} className="flex items-start gap-2">
                    {f.included ? (
                      ...
                      <X className="size-3.5 text-[#4a5168] shrink-0 mt-0.5" />
                    )}
                    <span className={`text-[11px] leading-relaxed ${f.included ? "text-[#8892b0]" : "text-[#4a5168]"}`}>
                      {f.label}
                    </span>
                  </li>
                ))}
              ...
              <a
                href={tier.ctaHref}
                className={`w-full py-2.5 rounded-xl text-sm text-center transition-all block ${tier.ctaStyle}`}
              >
                {tier.cta}
              </a>
            </div>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-[#2f374f] bg-[#1a1e2e]">
                <th className="text-left px-5 py-3 text-[#8892b0] text-xs font-semibold w-[40%]">Feature</th>
                <th className="text-center px-3 py-3 text-[#8892b0] text-xs font-semibold">Free</th>
                <th className="text-center px-3 py-3 text-[#57D7BA] text-xs font-semibold">Pro</th>
                <th className="text-center px-3 py-3 text-[#f59e0b] text-xs font-semibold">Quant API</th>
                <th className="text-center px-3 py-3 text-[#8b5cf6] text-xs font-semibold">Premium</th>
              </tr>
            </thead>
            <tbody>
              {COMPARISON.map((section) => (
                <React.Fragment key={section.heading}>
                  <tr className="bg-[#1a1e2e]/60">
                    <td colSpan={5} className="px-5 py-2 text-[10px] font-bold tracking-widest text-[#4a5168] uppercase">
                      {section.heading}
                    </td>
                  </tr>
                  {section.rows.map((row, i) => (
                    ...
                    >
                      <td className="px-5 py-2.5 text-[#8892b0] text-xs">{row.label}</td>
                      <td className="px-3 py-2.5 text-center"><CellValue val={row.free} /></td>
                      <td className="px-3 py-2.5 text-center"><CellValue val={row.pro} /></td>
                      <td className="px-3 py-2.5 text-center"><CellValue val={row.quant} /></td>
                      <td className="px-3 py-2.5 text-center"><CellValue val={row.premium} /></td>
                    </tr>
                  ))}
                </React.Fragment>
              ))}
