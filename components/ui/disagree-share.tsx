...
export function DisagreeShareButton({ d }: { d: Disagreement }) {
  ...
  const handleTelegram = () => {
    window.open(`https://t.me/share/url?text=${encodeURIComponent(shareText)}`, "_blank", "width=550,height=420");
  };
  ...
  return (
    <div className="relative flex items-center gap-1.5">
      ...
      <Button
        ...
        className="border-[#2f374f] text-[#8892b0] hover:text-[#2AABEE] hover:border-[#2AABEE]/30 gap-1"
